...
cp modules/pkcs11/arm64/pkcs11.a $TARGET_LIBRARY_PATH/libpkcs11.a
cp modules/grpc/arm64/libgrpc_node.a $TARGET_LIBRARY_PATH/libgrpc_node.a
...
#cp $LIBRARY_PATH/libuv.a $TARGET_LIBRARY_PATH/
#cp $LIBRARY_PATH/libzlib.a $TARGET_LIBRARY_PATH/
cp modules/pkcs11/x64/pkcs11.a $TARGET_LIBRARY_PATH/libpkcs11.a
cp modules/grpc/x64/libgrpc_node.a $TARGET_LIBRARY_PATH/libgrpc_node.a
...
lipo -create "$TARGET_LIBRARY_PATH/arm64/libpkcs11.a" "$TARGET_LIBRARY_PATH/x64/libpkcs11.a" -output "$TARGET_LIBRARY_PATH/libpkcs11.a"
lipo -create "$TARGET_LIBRARY_PATH/arm64/libgrpc_node.a" "$TARGET_LIBRARY_PATH/x64/libgrpc_node.a" -output "$TARGET_LIBRARY_PATH/libgrpc_node.a"
